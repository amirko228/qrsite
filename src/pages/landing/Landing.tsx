              ...
              <Box sx={{ mb: 4 }}>
                ...
                >
                  <Typography variant="h2" component="h1" gutterBottom>
                    Сохраняем память о близких в цифровом пространстве
                  </Typography>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  <Typography variant="h5" color="textSecondary" paragraph>
                    Создайте мемориальную страницу с историями, фотографиями и видео. Поделитесь воспоминаниями через QR-код.
                  </Typography>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
